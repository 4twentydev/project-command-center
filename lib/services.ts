...
export const publicServices = [
  ...
  },
  {
    ...
    icon: "website",
    primary: false,
    eyebrow: "Customer acquisition · useful websites",
    headline: "A website should create the next useful customer action.",
    summary: "Fast, focused sites designed to generate qualified calls, appointment requests, quote requests, or orders—and to hand those requests into an operating process the business can actually manage.",
    targetCustomer: "Small service, trade, fabrication, and local businesses that need a credible web presence tied to a specific customer action rather than a brochure that ends at page views.",
    problems: [
    ...
    deliverables: ["Focused service or company websites", "Quote-request and project-intake forms", "Appointment or booking handoffs", "Service and case-study content architecture", "Lead attribution and follow-up workflow", "Performance, accessibility, and search foundations"],
    process: [
      { title: "Define the conversion", description: "Choose the primary action the site must produce and the minimum information needed to make that action useful." },
      { title: "Build the decision path", description: "Organize services, fit, proof, process, pricing context, and objections around the questions a qualified prospect actually asks." },
      { title: "Prototype the intake", description: "Design forms and calls to action together with the internal response, routing, and follow-up process." },
      ...
      { title: "Verify the full handoff", description: "Test direct routes, metadata, form validation, storage, notifications, and the next step after submission before launch." },
    ],
    caseStudyLinks: [
    ...
    typicalEngagement: { label: "Typically $1,500–$3,500 for a focused site or conversion sprint; connected portals and custom systems start higher", note: "Planning range only. Content volume, approved assets, booking or commerce services, integrations, and ongoing support determine final scope." },
    faqs: [
    ...
    cta: { label: "Plan a website that produces action", href: "/?service=small-business-websites&engagement=workflow-sprint#contact" },
    defaultEngagementId: "workflow-sprint",
    contactProjectType: "Small-Business Websites",
    seo: { title: "Small-Business Websites", description: "Small-business websites built to generate calls, appointments, quote requests, or orders and connect those leads to a workable follow-up process." },
    futureCaseStudies: ["A service-business website with verified inquiry-quality evidence", "A booking-focused site with documented handoff and follow-up", "A quote-request experience connected to an actual estimating workflow"],
  },
  {
    ...
    caseStudyLinks: [
      { slug: "signforge", relevance: "An active concept for connecting custom sign intake, quoting, approvals, material planning, production stages, and delivery. It is not presented as a deployed system." },
