...
export const consultationPlaybooks: readonly ConsultationPlaybook[] = [
  ...
  },
  {
    ...
    objective: "Define one primary customer action and the complete operational handoff from visit to qualified follow-up.",
    callPlan: ["Define the primary conversion", "Identify the best-fit visitor", "Map their decision questions", "Design intake and response", "Confirm content, proof, measurement, and launch ownership"],
    evidenceToRequest: ["Current site and analytics access when available", "Real service descriptions, process details, and pricing context", "Approved photos, credentials, testimonials, and case evidence", "Recent inquiry examples and the actual follow-up process"],
    cautionSignals: ["No primary conversion is chosen", "Unverified claims or placeholder proof are treated as final", "The form ends in an unowned inbox", "Search rankings or lead volume are expected to be guaranteed"],
    sections: [
      { id: "context", title: "Business context", description: "Identify the audience, offer, and business reason for the site.", fields: commonContextFields },
      { id: "conversion", title: "Visitor decision path", description: "Build around the next useful action, not a generic page list.", fields: [
        { id: "primary-conversion", label: "Primary conversion", prompt: "Should the right visitor call, book, request a quote, order, visit, or take another specific action?", kind: "select", required: true, options: ["Phone call", "Appointment request", "Quote request", "Order or purchase", "Qualified contact", "Other"] },
        { id: "best-fit-customer", label: "Best-fit customer", prompt: "Who should recognize themselves immediately, and which inquiries are not a fit?", kind: "long", required: true },
        ...
        { id: "lead-handoff", label: "Lead handoff", prompt: "What happens after submission, who responds, how quickly, and what information makes the lead useful?", kind: "long", required: true },
      ] },
      { id: "content", title: "Content and evidence", description: "Separate approved source material from content still needed.", fields: [
        { id: "content-inventory", label: "Available content", prompt: "List existing copy, photos, logo files, service details, policies, locations, and FAQs.", kind: "long" },
      ...
      { id: "outcome", title: "Scope and outcome", description: "Define the smallest complete site and its measurable customer action.", fields: commonOutcomeFields },
      { id: "delivery", title: "Development handoff", description: "Confirm domains, services, content approvals, measurement, and ownership.", fields: commonDeliveryFields },
    ],
    developmentGate: ["Primary conversion and best-fit visitor are approved", "Page and content inventory maps to real decision questions", "Every public claim and asset has an owner and approval state", "Form storage, notification, response, attribution, and failure paths are defined", "Domain, analytics, search, accessibility, launch, and maintenance ownership are assigned"],
  },
  {
