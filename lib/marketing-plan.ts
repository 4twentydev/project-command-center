...
export const launchWeeks = [
  ...
  { week: 8, phase: "Proof", focus: "Sign and fabrication network", actions: ["Attend or request guest access to one relevant event", "Make three genuine contacts", "Follow up within two business days"], content: "SignForge as an active concept, not a client result" },
