...
export function isWorkspaceData(value: unknown): value is Workspace {
  ...
  return Array.isArray(candidate.projects) && Array.isArray(candidate.tasks) && Array.isArray(candidate.activity) && (candidate.reviews === undefined || Array.isArray(candidate.reviews));
}
