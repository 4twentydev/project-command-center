...
export function ContactForm() {
  ...
  const trackStart = () => { if (!started.current) { started.current = true; trackConversionEvent("contact_form_start"); } };
  return <form action={action} onFocusCapture={trackStart} className="space-y-5">
