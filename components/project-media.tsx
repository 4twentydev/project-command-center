...
function ResponsiveScreenshot({ media, className, onError }: { media: ProjectScreenshotMedia; className?: string; onError: () => void }) {
  const sizes = "(max-width: 767px) calc(100vw - 40px), (max-width: 1279px) calc(100vw - 64px), 1152px";
